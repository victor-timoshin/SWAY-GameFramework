...
namespace Imaging
{
	...
	Gapi::PTEXTURE_DESCRIPTION TGALoader::LoadFromStream(std::istream& source)
	{
		...
		Gapi::PTEXTURE_DESCRIPTION textureDesc;
		textureDesc = (Gapi::PTEXTURE_DESCRIPTION)malloc(sizeof(Gapi::LTEXTURE_DESCRIPTION));
	...
	Gapi::PTEXTURE_DESCRIPTION TGALoader::LoadFromFile(const std::string& path)
	{
